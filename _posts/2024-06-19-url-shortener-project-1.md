---
title: URL 단축 서비스의 원리 파악하기(Url Shortener - 1)
...
![clickreq](../post_images/2024-06-19-url-shortener-project-1/shortcode.png){: width="972" height="589" .w-60}
...
이번에 프로젝트에서는 해시 함수와 Base62 인코딩을 사용하는 방식으로 구현할 것이다. 이유는 별게 없다.
