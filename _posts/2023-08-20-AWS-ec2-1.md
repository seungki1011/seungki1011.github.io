...
---
---
유튜브에 있는 "쉽게 설명하는 AWS", AWS documentation을 통해 AWS에 대한 소개, AWS EC2 소개 및 인스턴스 생성까지 다룬 포스트. 
...
<img src="../post_images/2023-09-19-AWS-ec2-1/awsuser2.png" alt="aws 유저 2" style="zoom: 33%;" class='center-image'/>
